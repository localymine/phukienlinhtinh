...
add_action( 'woocommerce_before_shop_loop', 'woocommerce_ordering_wrap_open', 10 );
add_action( 'woocommerce_before_shop_loop', 'woocommerce_ordering_wrap_close', 40 );
function woocommerce_ordering_wrap_open() {
	?>
		<div class="ordering-wrap">
	<?php
}
function woocommerce_ordering_wrap_close() {
	?>
		</div>
	<?php
}
